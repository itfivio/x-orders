...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'cosdlazdrowia' => [
            'driver' => 'mysql',
            'url' => env('DB_COSDLAZDROWIA_URL'),
            'host' => env('DB_COSDLAZDROWIA_HOST', '127.0.0.1'),
            'port' => env('DB_COSDLAZDROWIA_PORT', '3306'),
            'database' => env('DB_COSDLAZDROWIA_DATABASE', 'laravel'),
            'username' => env('DB_COSDLAZDROWIA_USERNAME', 'root'),
            'password' => env('DB_COSDLAZDROWIA_PASSWORD', ''),
            'unix_socket' => env('DB_COSDLAZDROWIA_SOCKET', ''),
            'charset' => env('DB_COSDLAZDROWIA_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COSDLAZDROWIA_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => true,
            'engine' => null,
